...
Sempre que aparecer marcelomacedo, você precisa substituir pelo seu usuário no DockerHub.
...
```sh
$ docker run -d --name nginx -p 80:80 --link node marcelomacedo/nginx:devops
$ docker ps
```
...
- Linha 8 = marcelomacedo/nginx:devops
- Linha 18 = image: marcelomacedo/redis:devops
- Linha 37 = image: marcelomacedo/node:devops
